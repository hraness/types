...
The root `AGENTS.md` is the repository's normative control plane. Its rules apply before deeper lookup. Types is the runtime-free `@hraness/types` package for stable general-purpose TypeScript utility invariants.
